/**
 * DoctorStatCard — An isolated stat card for the Doctor Dashboard.
 * Intentionally scoped to doctor context only.
 */
export default function DoctorStatCard({ icon, label, value, loading, onClick }) {
  if (loading) {
    return (
